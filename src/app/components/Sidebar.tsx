...
export default function Sidebar() {
  ...
  return (
    <div className="hidden md:block fixed top-0 left-0 h-screen w-52 px-4 pt-10 flex-col bg-white dark:bg-[#111] border-r border-gray-100 dark:border-[#1a1a1a] z-40 flex">
      {/* Identity */}
